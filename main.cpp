...
int main()
{
	...
	mg1.add_player(&dl);
	cout << "Damian Lilard was added." << endl;
	...
	cout << "-----------------------------------------------------" << endl;
	cout << endl << "Print just the opening five for compare." << endl;
	...
	cout << "-----------------------------------------------------" << endl;
	cout << "Warning! we replaced between Dor Haimo(10) & Rabi Nahman(1) after it" << endl;
	cout << "Please choose 10 and DO NOT choose 1 in the opening five" << endl;
	...
	if (p1 < p2)
		cout << p1.scoreAssistsRatio() << endl;

	cout << "I have bigger ratio: " << endl << endl;
	if (p2 > p1)
		cout << p2.scoreAssistsRatio() << endl;
